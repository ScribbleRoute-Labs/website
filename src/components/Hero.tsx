...
interface DrawPath {
  ...
  color: string
  width: number
  type: 'free' | 'circle' | 'triangle' | 'square'
}
...
export function Hero() {
  ...
  return (
    <section id="hero" className="w-full py-12 flex flex-col items-center">
      {/* Brand Header */}
      <header className="w-full flex items-center justify-between py-6 border-b border-neutral-900 mb-16">
        ...
        >
          <Github className="w-3.5 h-3.5 text-neutral-500 group-hover:text-white" />
          <span>Github</span>
      ...
      {/* Hero Headline */}
      <div className="text-center max-w-2xl space-y-6 mb-16">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.08] text-white">
          A digital toy chest <br />
          <span className="bg-gradient-to-r from-neon-purple via-neon-pink to-neon-teal bg-clip-text text-transparent">
            built for toddler autonomy.
          </span>
        </h1>
        <p className="text-text-muted text-base sm:text-lg max-w-lg mx-auto font-medium">
          Zero subscriptions. Zero tracking. 100% offline out-of-the-box software designed for children, parents, and engineers.
        </p>
        <div className="flex justify-center gap-3">
          <a
            href="#pricing"
            className="px-5 py-2.5 text-sm font-semibold rounded-lg bg-white text-black hover:bg-neutral-200 transition-colors shadow-lg"
          >
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-7 flex flex-col">
          <div className="w-full bg-neutral-900/40 rounded-2xl border border-neutral-800/80 p-4 sm:p-6 shadow-2xl flex flex-col flex-1 relative overflow-hidden">
            ...
            <div className="relative w-full aspect-video bg-neutral-950 rounded-xl border border-neutral-850 overflow-hidden cursor-crosshair group shadow-inner">
              ...
              {paths.length === 0 && !isDrawing && (
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 pointer-events-none select-none">
                  <div className="w-10 h-10 rounded-full bg-neutral-900 border border-neutral-800 flex items-center justify-center mb-2 animate-bounce">
                    🎨
                  </div>
            ...
            {/* Zero-Text Subpanels: Animal Sound Popper Simulator (Visual triggers only) */}
        ...
        <div className="lg:col-span-5 flex flex-col">
          <div className="w-full bg-neutral-900/40 rounded-2xl border border-neutral-800/80 p-4 sm:p-6 shadow-2xl flex flex-col flex-1 relative overflow-hidden">
            ...
            <div className="space-y-5 flex-1">
              ...
              {/* Real-time stateless switchboard routing log */}
              {pushLogs.length > 0 && (
              ...
              {/* SQLite database console output log */}
